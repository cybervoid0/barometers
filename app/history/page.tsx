    ...
    <Container className={sx.page}>
      ...
      <ShowMore>
        ...
        <Text className={sx.paragraph}>
          ...
          barometer&apos;s pointer. This mechanism became the foundation of the so-called standard
          continental console mechanism, which ensured the smooth and precise conversion of the
