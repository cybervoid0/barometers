...
import { imageStorage, BAROMETERS_PER_CATEGORY_PAGE } from '@/constants/globals'
import { FrontRoutes } from '@/constants/routes-front'
import { BarometerCard } from '@/components/barometer-card'
import { SortValue, SortOptions, DynamicOptions } from '@/types'
import Sort from './sort'
import { ShowMore } from '@/components/showmore'
import { title, openGraph, twitter } from '@/constants/metadata'
import { Pagination, Card } from '@/components/ui'
import { withPrisma } from '@/prisma/prismaClient'
import { getCategory, getBarometersByParams } from '@/services'
import { FooterVideo } from '@/components/containers/footer'
