...
const subheaderStyles = 'mb-4 text-lg font-medium'
  ...
  return (
    <Container py="xl">
      <Paper shadow="lg" px={{ base: 'md', xs: 'xl' }} py={{ base: 'md', xs: 'xl' }}>
        ...
        <Text pb="xs" className={paragraphStyles}>
        ...
        <ShowMore>
          ...
          <Title component="h3" className={subheaderStyles}>
            Master Woodworkers
          </Title>
          <Text className={paragraphStyles}>
          ...
          <Text mt="lg" className={paragraphStyles}>
