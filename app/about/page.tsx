...
const paragraph = '!mb-4 text-left indent-8'
const bookTitle = 'font-medium italic'
const subheader = 'mb-4 text-lg font-medium'
    ...
    <Container py="xl">
      <Paper shadow="lg" px={{ base: 'md', xs: 'xl' }} py={{ base: 'md', xs: 'xl' }}>
        ...
        <Text className={paragraph}>
          ...
          <span className={bookTitle}>Barometer Odyssey*</span>, a book that explores the evolution
        ...
        <Text pb="xs" className={paragraph}>
        ...
        >
          <Text className={paragraph}>
            <span className={bookTitle}>*Barometer Odyssey</span> immerses the reader in the world
            ...
            aneroid mechanisms, each chapter unveils the captivating story of the barometer.
        ...
        <ShowMore>
          ...
          <h3 className={subheader}>Master Woodworkers</h3>
          <Text className={paragraph}>
          ...
          <h3 className={subheader}>Wood Carvers</h3>
          <Text className={paragraph}>
          ...
          <h3 className={subheader}>Glassblowers</h3>
          <Text className={paragraph}>
          ...
          <h3 className={subheader}>Engravers and Enamelers</h3>
          <Text className={paragraph}>
          ...
          <h3 className={subheader}>Mechanics and Clockmakers</h3>
          <Text className={paragraph}>
          ...
          <Text mt="lg" className={paragraph}>
