  ...
  return (
    <Container py="xl">
      ...
      <Text className={styles.paragraph}>
        ...
        has also inspired me to write <span className={styles.bookTitle}>Barometer Odyssey*</span>,
        a book that explores the evolution of barometers over time.
      </Text>
      <Text className={styles.paragraph}>
      ...
      <ShowMore>
        ...
        <Text className={styles.paragraph}>
          ...
          meticulous work. The fonts used for weather changes (“Fair,” “Rain,” “Change”) were chosen
          to be both aesthetically pleasing and legible.
        </Text>
        <Text className={styles.paragraph}>
